...
func getPagespeedAnalysisAggregatedColumns() []*plugin.Column {
	return []*plugin.Column{
		...
		{
			Name:        "ttf",
			Description: "The Time to First Byte (TTF) of the page.",
			Type:        proto.ColumnType_STRING,
		...
		{
			Name:        "ttf_percentile",
			Description: "The percentile of the Time to First Byte (TTF) of the page.",
			Type:        proto.ColumnType_INT,
		...
		{
			Name:        "ttf_bucket_range",
			Description: "The bucket range of the Time to First Byte (TTF) of the page.",
			Type:        proto.ColumnType_JSON,
